...
const uint32_t TableStruct_cpu_5fload_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::monitor::proto::CpuLoad, _impl_.load_avg_5_),
...
const ::_pbi::DescriptorTable descriptor_table_cpu_5fload_2eproto = {
    false, false, 111, descriptor_table_protodef_cpu_5fload_2eproto,
    "cpu_load.proto",
...
CpuLoad::CpuLoad(const CpuLoad& from)
  ...
  ::memcpy(&_impl_.load_avg_1_, &from._impl_.load_avg_1_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.load_avg_15_) -
...
uint8_t* CpuLoad::_InternalSerialize(
  ...
  if (raw_load_avg_1 != 0) {
    ...
    target = ::_pbi::WireFormatLite::WriteFloatToArray(1, this->_internal_load_avg_1(), target);
  }
  ...
  if (raw_load_avg_5 != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(2, this->_internal_load_avg_5(), target);
  }
  ...
  if (raw_load_avg_15 != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteFloatToArray(3, this->_internal_load_avg_15(), target);
  }
...
template<> PROTOBUF_NOINLINE ::monitor::proto::CpuLoad*
Arena::CreateMaybeMessage< ::monitor::proto::CpuLoad >(Arena* arena) {
