...
// float load_avg_5 = 2;
inline void CpuLoad::clear_load_avg_5() {
  _impl_.load_avg_5_ = 0;
}
inline float CpuLoad::_internal_load_avg_5() const {
  return _impl_.load_avg_5_;
}
inline float CpuLoad::load_avg_5() const {
  // @@protoc_insertion_point(field_get:monitor.proto.CpuLoad.load_avg_5)
  return _internal_load_avg_5();
}
inline void CpuLoad::_internal_set_load_avg_5(float value) {
  
  _impl_.load_avg_5_ = value;
}
inline void CpuLoad::set_load_avg_5(float value) {
  _internal_set_load_avg_5(value);
  // @@protoc_insertion_point(field_set:monitor.proto.CpuLoad.load_avg_5)
}
